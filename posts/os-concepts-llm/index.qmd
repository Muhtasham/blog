...
Virtual memory acts as a backup system for a computer's primary memory, the Random Access Memmory (RAM). When the RAM is full, the computer uses a part of its storage space (like a hard drive) to keep things going. This helps the computer do more things at once.
