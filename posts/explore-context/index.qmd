...
Transformers process input, Not sequentially but in parallel, hence need a way to know the order of the words
...
factor. Adn this method of Linear scaling was independently and simultaneously discovered by the Reddit user /u/kaiokendev and the [Meta team](https://arxiv.org/abs/2306.15595)
...
to reside in the pretrained range](linear_interpolation.png)
