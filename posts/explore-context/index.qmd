...
In the [paper](https://github.com/jquesnelle/yarn/blob/master/paper/yarn.pdf) authors successfully extended the context length of LLAMA 2 13B to 128k training only for additional 400 steps!
