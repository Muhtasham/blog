...
As a [Cerebras Fellow](https://www.cerebras.ai/fellows) and [Codex Ambassador](https://developers.openai.com/codex/ambassadors/), right after Codex-Spark launched, I wanted to build something immediately graspable—a single interactive page where you adjust defect rates, run remap logic, and watch packets reroute in real time.
