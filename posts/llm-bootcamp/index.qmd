...
[Josh Tobin](https://www.linkedin.com/in/josh-tobin-4b3b10a9/) had great slides on this topic, which will be release soon, but in essence it is more detailed version of the below figure

![Comparisons of LLMs from [LightningAI](https://lightning.ai/pages/community/community-discussions/the-ultimate-battle-of-language-models-lit-llama-vs-gpt3.5-vs-bloom-vs/)](llm-comparison.jpg)
...
However, in the past, there have been concerns regarding broad copyright ownership over any output. Fortunately, with advancements in technology, such as the Azure OpenAI Service, these concerns are becoming less of a problem. OpenAI is now empowering users by offering services that allow for the use of proprietary models without worrying about copyright issues. This makes it easier for businesses to leverage the benefits of proprietary models while also protecting their intellectual property.
...
> Personally I find it quite distressing that LLAMA paper results could not be [reproduced](https://twitter.com/abacaj/status/1652066990033362944?s=20). 
